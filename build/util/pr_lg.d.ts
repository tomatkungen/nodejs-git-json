...
import { GitCommitFile, GitConfig, GitLog, GitLogShort, GitRef, GitStash, Gitstatus, GitUser, GitCommitHunk, GitUserCommitLength } from "../types/git_types";
...
export declare const pr_users_commit_length: (gitUsersCommitLength: GitUserCommitLength) => void;
